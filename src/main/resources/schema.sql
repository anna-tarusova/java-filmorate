...
ALTER TABLE PUBLIC.FILM_GENRES ADD CONSTRAINT IF NOT EXISTS FILM_GENRES_FILM_FK FOREIGN KEY (FILM_ID) REFERENCES PUBLIC.FILM(ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
ALTER TABLE PUBLIC.FILM_GENRES ADD CONSTRAINT IF NOT EXISTS FILM_GENRES_GENRE_FK FOREIGN KEY (GENRE_ID) REFERENCES PUBLIC.GENRE(ID) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
CREATE UNIQUE INDEX IF NOT EXISTS USER_NAME_INDEX ON PUBLIC."USER" (NAME);
CREATE UNIQUE INDEX IF NOT EXISTS USER_LOGIN_INDEX ON PUBLIC."USER" (login);
